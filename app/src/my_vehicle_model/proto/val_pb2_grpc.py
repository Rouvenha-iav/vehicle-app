...
class VALStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                request_serializer=val__pb2.GetRequest.SerializeToString,
                response_deserializer=val__pb2.GetResponse.FromString,
                )
        self.Set = channel.unary_unary(
                '/kuksa.val.v1.VAL/Set',
                request_serializer=val__pb2.SetRequest.SerializeToString,
                response_deserializer=val__pb2.SetResponse.FromString,
                )
        self.Subscribe = channel.unary_stream(
                '/kuksa.val.v1.VAL/Subscribe',
                request_serializer=val__pb2.SubscribeRequest.SerializeToString,
                response_deserializer=val__pb2.SubscribeResponse.FromString,
                )
        self.GetServerInfo = channel.unary_unary(
                '/kuksa.val.v1.VAL/GetServerInfo',
                request_serializer=val__pb2.GetServerInfoRequest.SerializeToString,
                response_deserializer=val__pb2.GetServerInfoResponse.FromString,
                )
...
def add_VALServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=val__pb2.GetRequest.FromString,
                    response_serializer=val__pb2.GetResponse.SerializeToString,
            ),
            'Set': grpc.unary_unary_rpc_method_handler(
                    servicer.Set,
                    request_deserializer=val__pb2.SetRequest.FromString,
                    response_serializer=val__pb2.SetResponse.SerializeToString,
            ),
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=val__pb2.SubscribeRequest.FromString,
                    response_serializer=val__pb2.SubscribeResponse.SerializeToString,
            ),
            'GetServerInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.GetServerInfo,
                    request_deserializer=val__pb2.GetServerInfoRequest.FromString,
                    response_serializer=val__pb2.GetServerInfoResponse.SerializeToString,
            ),
    }
...
class VAL(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/kuksa.val.v1.VAL/Get',
            val__pb2.GetRequest.SerializeToString,
            val__pb2.GetResponse.FromString,
    ...
    def Set(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/kuksa.val.v1.VAL/Set',
            val__pb2.SetRequest.SerializeToString,
            val__pb2.SetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/kuksa.val.v1.VAL/Subscribe',
            val__pb2.SubscribeRequest.SerializeToString,
            val__pb2.SubscribeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetServerInfo(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/kuksa.val.v1.VAL/GetServerInfo',
            val__pb2.GetServerInfoRequest.SerializeToString,
            val__pb2.GetServerInfoResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
